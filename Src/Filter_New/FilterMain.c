...
VOID FilterDeviceContextCleanup(IN WDFOBJECT Device){
    ULONG   count;
...
NTSTATUS FilterCreateControlDevice(WDFDEVICE Device){
    ...
    pInit = NULL;// WdfControlDeviceInitAllocate(WdfDeviceGetDriver(Device), &SDDL_DEVOBJ_SYS_ALL_ADM_RWX_WORLD_RW_RES_R);
    if (pInit == NULL){
